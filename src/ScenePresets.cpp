        ...
        case 3:
            {
                ...
                for (size_t i = 0; i < particles - 1; i++) {
                    pVector.push_back(new Particle(center + (i + 1) * Vec2f(0, rod_length), visualizeForces, i));
                }
                pVector.push_back(new Particle(center + particles * Vec2f(0.001, rod_length), visualizeForces, particles - 1));
