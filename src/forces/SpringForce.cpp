...
std::vector<Force::JacobianEntry> SpringForce::getJx() {
    Vec2f d = m_p2->m_Position - m_p1->m_Position;
    ...
    return {
        JacobianEntry {m_p1, m_p2, - s1[0] - d1[0], - s1[1] - d1[1], - s2[0] - d2[0], - s2[1] - d2[1]},
        JacobianEntry {m_p2, m_p1, - s1[0] - d1[0], - s1[1] - d1[1], - s2[0] - d2[0], - s2[1] - d2[1]},
        JacobianEntry {m_p1, m_p1, s1[0] + d1[0], s1[1] + d1[1], s2[0] + d2[0], s2[1] + d2[1]},
        JacobianEntry {m_p2, m_p2, s1[0] + d1[0], s1[1] + d1[1], s2[0] + d2[0], s2[1] + d2[1]},
    };
}


std::vector<Force::JacobianEntry> SpringForce::getJv() {
