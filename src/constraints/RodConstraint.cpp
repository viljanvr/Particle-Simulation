...
RodConstraint::RodConstraint(Particle *p1, Particle *p2, double dist, size_t index) : Constraint(index), m_p1(p1), m_p2(p2), m_dist(dist) {}

std::vector<Constraint::JacobianEntry> RodConstraint::getJacobian() {
...
std::vector<Constraint::JacobianEntry> RodConstraint::getJacobianDeriv() {
